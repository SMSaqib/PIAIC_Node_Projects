...
import { CourseRepository } from "./Course/course.js";
import { login, ForgetPAssword, FurtherAction, Std_remove_record, Std_update_record, get_Student_Porgamm_Input, get_Student_Semester_Input } from './functions/student_fucntions.js';
...
const relativeFilePath = 'students.db';
...
switch (confirmation.IConfirmation) {
    case "Register":
        ...
        let semeseter_selection = await Coursedetail_repository.Semester_list(course_selection.IProgm);
